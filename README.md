...
마법사는 14개 단계로 구성됩니다. (상세: [PLAN.md](PLAN.md) §4)
...
10. **에이전트 능력 & 컨텍스트** — 서브에이전트, 명확화 질문, 내장 도구, 장기 기억, 컨텍스트 자동압축·사용량 미터, 안전(거절/남용)
11. **연동 & API** — 외부/내부 API, 도구 사용(tool use), 웹훅
12. **평가 & 테스트** — 골든 질의셋, 평가 지표(인용 적중 등), 합격선
13. **컴플라이언스** — 개인정보, 보안, 접근성(KWCAG), 조달/라이선스/인증
14. **운영 · 관측 · 비용** — 감사 로그, 관측(토큰·지연), 성능/SLA, 비용 추정
